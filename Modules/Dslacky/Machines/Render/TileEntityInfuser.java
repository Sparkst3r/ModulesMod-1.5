...
public void updateEntity()
{
         ...
         if (!this.worldObj.isRemote)
         {
                 ...
                 {
                         var2 = true;
                         Infuser.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                 }
         }
...
private boolean canSmelt()
{
         ...
         {
                 ItemStack var1 = InfuserRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
...
public static int getItemBurnTime(ItemStack par0ItemStack)
{
         ...
         else
         {
                 ...
                 if (par0ItemStack.getItem() instanceof ItemBlock && Block.blocksList[var1] != null)
                	 ...
                	 if (var1 == Item.coal.itemID) return 200;
            	 if (var1 == Item.coal.itemID) return 200;
            	 if (var1 == Item.coal.itemID) return 200;
;
