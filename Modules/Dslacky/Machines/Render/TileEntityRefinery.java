...
import Modules.Dslacky.Machines.Extra.RefineryRecipes;
...
public class TileEntityRefinery extends TileEntity implements IInventory, ISidedInventory
{
...
public void updateEntity()
{
         ...
         if (!this.worldObj.isRemote)
         {
                 ...
                 {
                         var2 = true;
                         Refinery.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                 }
         }
...
private boolean canSmelt()
{
         ...
         {
                 ItemStack var1 = RefineryRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
