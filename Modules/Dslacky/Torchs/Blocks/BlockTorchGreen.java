...
public class BlockTorchGreen extends Block
{
    public BlockTorchGreen(final int par1, final int par2)
    {
        ...
        this.setUnlocalizedName("BlockTorchGreen");
    }
    ...
    public int func_85104_a(final World par1World, final int par2, final int par3, final int par4, final int par5, final float par6, final float par7, final float par8, final int par9)
    {
        int var10 = par9;
