...
public class BlockTorchPurple extends Block
{
    private Object TileEntityTerra;

	public BlockTorchPurple(int par1, int par2)
    {
        super(par1, Material.circuits);
        this.setTickRandomly(true);
        this.setCreativeTab(CreativeTabs.tabDecorations);
        this.setUnlocalizedName("BlockTorchPurple");
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var6 == 1)
        {
            par1World.spawnParticle("witchMagic", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
        ...
        {
            par1World.spawnParticle("witchMagic", var7, var9 + var13, var11 + var15, 0.0D, 0.0D, 0.0D);
        }
        else
        {
            par1World.spawnParticle("witchMagic", var7, var9, var11, 0.0D, 0.0D, 0.0D);
        }
    }
}