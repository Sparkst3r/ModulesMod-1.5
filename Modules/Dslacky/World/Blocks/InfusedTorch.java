...
public class InfusedTorch extends Block {
	 ...
	 * @param material
	 */
	public InfusedTorch(int id) {
		super(id, Material.circuits);
		this.setHardness(0.0F);
		GameRegistry.registerBlock(this, ItemBlockInfusedTorch.class, "InfusedTorch");
	...
	public void registerIcons(IconRegister ir) {
		...
		iconBuffer[0] = ir.registerIcon(id + "blueTorch");
		iconBuffer[1] = ir.registerIcon(id + "greenTorch");
		iconBuffer[2] = ir.registerIcon(id + "redTorch");
		iconBuffer[3] = ir.registerIcon(id + "purpleTorch");
		iconBuffer[4] = ir.registerIcon(id + "whiteTorch");
	}
    /**
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var6 == 1)
        {
            par1World.spawnParticle("splash", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("spell", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
        ...
        {
            par1World.spawnParticle("splash", var7, var9 + var13, var11 - var15, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("spell", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
        ...
        {
            par1World.spawnParticle("splash", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
        	par1World.spawnParticle("spell", var7, var9 + var13, var11 + var15, 0.0D, 0.0D, 0.0D);
        }
        else
        {
            par1World.spawnParticle("splash", var7 - var15, var9 + var13, var11, 0.0D, 0.0D, 0.0D);
        	par1World.spawnParticle("spell", var7, var9, var11, 0.0D, 0.0D, 0.0D);
        }
    }
